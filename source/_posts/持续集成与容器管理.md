...
tags:  
     ...
     - "Grafana"
---
<!-- Jenkins，Rancher ，influxDB ，cAdvisor，Grafana -->
# 持续集成与容器管理  
...
![](images/持续集成与容器管理/image/9_86.png)

 

![](images/持续集成与容器管理/image/9_2.png)

（7）新建用户

![](images/持续集成与容器管理/image/9_3.png)

完成安装进入主界面

![](images/持续集成与容器管理/image/9_4.png)
...
（3）假设我的centos虚拟机IP为192.168.73.135   在地址栏输入http://192.168.73.135:3000  会进入首次运行安装程序页面，我们可以选择一种数据库作为gogs数据的存储，最简单的是选择SQLite3。如果对于规模较大的公司，可以选择MySQL  
...
![](images/持续集成与容器管理/image/8_5.png)

（4）注册

![](images/持续集成与容器管理/image/8_6.png)

（5）登录

![](images/持续集成与容器管理/image/8_9.png)

（6）创建仓库 ![创建仓库](images/持续集成与容器管理/image/8_1.png)

![](images/持续集成与容器管理/image/9_84.png)
...
![](images/持续集成与容器管理/image/9_85.png)
...
![](images/持续集成与容器管理/image/9_22.png)
...
![](images/持续集成与容器管理/image/10_05.png)
...
![](images/持续集成与容器管理/image/10_71.png)
